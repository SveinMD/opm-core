...
set output "testCase1-cputvscellc-s-x-T-2000-t-10-viscrat-".muw."_".muo.".tex"
set format xy "$%g$"
#set format xy "%g"
...
plot "testCase1-cputvscellc-s-r-T-2000-t-10.data" title "Regula Falsi" with linespoints, \
     "testCase1-cputvscellc-s-u-T-2000-t-10.data" title "Regula Falsi TR" with linespoints, \
     ...
     "testCase1-cputvscellc-s-ta-T-2000-t-10.data" title "Trust Region*" with linespoints ls 1
